...
권한에 따른 read 페이지 접근 및 댓글 작성<br>
-list에서 비밀글일때 사용자 정보를 통해 표시되는 내용의 차이 구분 및 접근 권한 설정<br>
 -수의사만 답변 가능한 글의 경우 사용자의 정보를 통해 댓글 작성 가능의 여부 구분<br><br>
페이지 유지<br>
-list 페이지에서 read 페이지로 이동할 때와
  myActivicty, allSearch 에서 read 페이지로 이동할때의 페이지 및 키워드 유지 구분<br><br>
검색 기능 및 필터 기능<br>
-비밀글 검색가능한 곳과 아닌곳 명확하게 구분<br>
-비밀글이 필터되야 하는 부분과 아닌 부분 구분<br>
-정렬이 필요한 부분의 정렬 기능 추가<br>
