...
- 김주희 : <br>
에러 처리 부분의 가시성을 향상시키기 위해 노력<br>
-error를 직접 발생시켜보니 CustomRestAdvice 쪽의 에러는 알아보기 힘든 부분이 있어 에러를 보고 위치를 추측할 수 있도록 전반적으로 모든 에러 코드를 수정하였습니다.<br><br>
페이지 및 키워드를 유지 구분<br>
-read 페이지에 접속하는 경로가 여러가지라 read페이지에 접속한 후 목록버튼을 통해 되돌아갈때 어떤 방식으로 페이지 및 키워드를 유지 시킬지 기준을 세웠고 그 기준을 통해 구분하도록 하였습니다.<br><br>
필터 연결<br>
-사용자가 적용시킬 수 있는 필터와 페이지에 접속할때 기본 적용되어 있는 필터들을 자연스럽게 연결하기위해 노력하였습니다.<br><br>
같은 template에서의 출력 구분<br>
-같은 template이라도 조건에 따라 다르게 보여질 수 있도록 구분하였습니다.<br>
